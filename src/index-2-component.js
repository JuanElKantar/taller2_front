                        ...
                        <div class="d-flex  flex-shrink-0 p-3" style="width: 222px; background-color: rgb(201, 205, 207); border-top-left-radius: 1rem; border-top-right-radius: 1rem; height: 15rem; ">
                            ...
                            <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="mt-2 text-center" style=" width: 5rem; border-radius: 5px; border: #13D659; background-color: #84bbf4; color: white;">Iniciar</button>
                                </div>
                            </ul>
                            <hr>
                        </div>
                    ...
                    <div class="d-flex justify-content-around ">
                        <div class=" ml-5">
                            <div class="row g-0 text-center pt-1 ">
                                <div class="col-sm-6 col-md-4 pt-2 border border-secondary font-weight-bold" style="width: 25rem; font-size: 20px; height: 5rem; border-radius: 7px;">Filtrar por  campaña</div>
                            </div>       
                        </div>
                        ...
                        <div class="d-flex justify-content-right ml-5">
                            <button class="mt-1 text-center" style=" width: 5rem; height: 50px; border-radius: 5px; border: #13D659; background-color: #84bbf4; color: white;">
                            <i class="fas fa-clock me-2"></i>10:00:00
                            </button>
